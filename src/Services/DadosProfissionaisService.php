...
class DadosProfissionaisService
{
    ...
    private DadosProfissionaisValidator $validator;

    public function __construct(DadosProfissionaisRepository $repository, DadosProfissionaisValidator $validator)
    {
